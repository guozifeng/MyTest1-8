...
/**
 * http://blog.csdn.net/u014082714/article/details/51423756
...
public class CollectTest1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("-------------");
		List<Integer> numsWithoutNull = nums.parallelStream().filter(num -> num != null).collect(() -> new ArrayList<Integer>(),
				(list, item) -> {
					list.add(item);
